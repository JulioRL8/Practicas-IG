...
#
$(TARGETS) : basic_object3d.o object3d.o axis.o tetrahedron.o practica1.o cube.o PLY.o revolucion.o file_ply_stl.o cilindro.o cono.o esfera.o extrusion.o transformation.o mesh.o grua.o light.o textura.o tablero.o
